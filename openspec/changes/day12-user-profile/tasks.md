...
- [x] 3.4 Гард табу-слов (D8): `_detect_taboo(dialogue_id, message)` (табу-
...
- [x] 6.2 Live-проверка «разные профили → разные ответы»: два диалога с
  ...
  в отчёте/выводе e2e.
- [x] 6.3 Гард табу-слов (e2e, live): диалог с `active`-профилем и табу —
...
- [x] 7.2 Финальная верификация: бэкенд pytest + фронтенд npm test +
