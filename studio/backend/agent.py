...
MCP_TOOLS_RULE = (
    ...
    "search {query:\"Самара\"} → summarize {text: <поле text из search>} → "
    "saveToFile {filename:\"samara_report.pdf\", content: <поле summary из "
    "summarize>, format:\"pdf\"} → в ответе сообщи, что и куда сохранено."
)
