...
# ограничения, тихое подчинение противоречащему запросу запрещено.
# Добавляется в system-сообщение только когда есть записи памяти.
MEMORY_RULE = (
    ...
    "сошлись на конкретный пункт памяти, кратко поясни противоречие и спроси, "
    "что делать: выполнить запрос вопреки памяти (пункт будет обновлён или "
    "удалён) или действовать по памяти."
)
